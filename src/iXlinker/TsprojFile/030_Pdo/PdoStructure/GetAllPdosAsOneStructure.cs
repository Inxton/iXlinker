...
namespace TsprojFile.Scan
{
    public partial class ScanTcProjFile : TcModel
    {
        private PdoViewModel GetAllPdosAsOneStructure(BoxViewModel boxViewModel, ObservableCollection<PdoViewModel> pdos)
        {
            ...
            BoxStructViewModel actBoxStruct = new BoxStructViewModel() { Prefix = ValidatePlcItem.Name(structName), BoxOrderCode = boxViewModel.BoxOrderCode , VendorId = boxViewModel.VendorId, Physics = boxViewModel.Physics, Description = boxViewModel.Description , NameOrigin = boxViewModel.Name };
