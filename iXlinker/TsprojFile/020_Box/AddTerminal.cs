...
namespace TsprojFile.Scan
{
    ...
    {
        private BoxViewModel AddTerminal(TcSmProjectProjectIODevice device, ref DeviceViewModel deviceVm, TcSmTermDef box, string parent_path)
        {
            BoxViewModel boxViewModel = new BoxViewModel();

            if ((!DoNotGenerateDisabled || !box.DisabledSpecified || !box.Disabled))
            {
